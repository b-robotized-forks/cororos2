...
def SpeedAccelDistanceM1M2_2(address, accel1, speed1, distance1, accel2, speed2, distance2, buffer):
    return _write4S444S441(
        address, Cmd.MIXEDSPEED2ACCELDIST, accel1, speed1, distance1, accel2, speed2, distance2, buffer
    )
...
def SpeedAccelDeccelPositionM1M2(
    address, accel1, speed1, deccel1, position1, accel2, speed2, deccel2, position2, buffer
):
