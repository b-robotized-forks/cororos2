...
2. Install the package by calling `colcon build --symlink-install --packages-select cororos2_cornelius_description`
3. (Re-)Source environment `source install/setup.bash`


> **NOTE:** If you use [RosTeamWorkspace (RTW)](https://rtw.b-robotized.com) than instead of the previous three steps, use `cb cororos2_cornelius_description` command.
...
or
```
ros2 launch cororos2_cornelius_description view_cornelius.launch.py
```
