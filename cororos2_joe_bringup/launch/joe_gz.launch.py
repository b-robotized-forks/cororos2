...
def generate_launch_description():
    pkg_bringup = get_package_share_directory("cororos2_joe_bringup")
    pkg_description = get_package_share_directory("cororos2_joe_description")
    ...
    controllers_file = os.path.join(pkg_bringup, "config", "joe_gz_controllers.yaml")
    xacro_file = os.path.join(pkg_description, "urdf", "joe.urdf.xacro")
    rviz_config = os.path.join(pkg_description, "rviz", "joe.rviz")
    floor_world = os.path.join(pkg_bringup, "worlds", "joe_floor.sdf")
    ...
    sensor_bridge = Node(
        ...
        arguments=[
            ...
            "/world/empty/model/joe/link/base_footprint/sensor/rgbd_front/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
        ],
        remappings=[
            ...
            (
                "/world/empty/model/joe/link/base_footprint/sensor/rgbd_front/image",
                "/joe/raw/rgbd_front/image_raw",
            ),
            (
                "/world/empty/model/joe/link/base_footprint/sensor/rgbd_front/depth_image",
                "/joe/raw/rgbd_front/depth_image",
            ),
            (
                "/world/empty/model/joe/link/base_footprint/sensor/rgbd_front/points",
                "/joe/raw/rgbd_front/points",
            ),
            (
                "/world/empty/model/joe/link/base_footprint/sensor/rgbd_front/camera_info",
                "/joe/raw/rgbd_front/camera_info",
            ),
        ],
        output="screen",
    )
